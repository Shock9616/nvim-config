    ...
    textobjects = {
        select = {
            ...
            keymaps = {
                ...
                ["am"] = { query = "@function.outer", desc = "Select the outer part of a method/function definition" },
                ["im"] = { query = "@function.inner", desc = "Select the inner part of a method/function definition" },
...
vim.keymap.set({ "n", "x", "o" }, "F", ts_repeat_move.buildin_F)
